...
public:
  ...
  void jsCB(const sensor_msgs::JointState::ConstPtr &joint_state) {
    ...
    curr_2 = joint_state->position[0];
    curr_3 = joint_state->position[3];
    ...
    int servo_0 = this->map(curr_0, 32.70, 147.29);
    //int servo_0 = 180 - this->map(curr_0, 32.70, 147.29); // FOREARM JOINT
    //int servo_1 = this->map(curr_1, 32.70, 147.29);
    int servo_1 = 180 - this->map(curr_1, 32.70, 147.29); // PLATFORM JOINT
    //int servo_2 = this->map(curr_2, 32.70, 147.29);
    int servo_2 = 180 - this->map(curr_2, 32.70, 147.29); // SHOULDER JOINT
    //int servo_3 = this->map(curr_3, 32.70, 147.29);
    int servo_3 = 180 - this->map(curr_3, 32.70, 147.29); // WRIST JOINT
